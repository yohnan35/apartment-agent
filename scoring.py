...
כל אובייקט: {"score": X.X, "score_reason": "הסבר קצר 1-2 משפטים בעברית", "is_broker_suspect": true/false}
"""
...
def bulk_score(
    ...
    try:
        ...
        print(f"[scoring] API error: {exc}")
        return [{"score": None, "score_reason": None, "is_broker_suspect": None}] * len(listings)
    ...
    for item in parsed:
        if item and isinstance(item, dict):
            ...
            results.append({"score": None, "score_reason": None, "is_broker_suspect": None})
